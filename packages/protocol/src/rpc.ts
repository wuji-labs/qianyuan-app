export const RPC_METHODS = {
  ...
  DAEMON_SESSION_FILES_UPLOAD_INIT: 'daemon.sessionFiles.upload.init',
  DAEMON_SESSION_FILES_UPLOAD_CHUNK: 'daemon.sessionFiles.upload.chunk',
  DAEMON_SESSION_FILES_UPLOAD_FINALIZE: 'daemon.sessionFiles.upload.finalize',
  DAEMON_SESSION_FILES_UPLOAD_ABORT: 'daemon.sessionFiles.upload.abort',
  DAEMON_SESSION_FILES_DOWNLOAD_INIT: 'daemon.sessionFiles.download.init',
  DAEMON_SESSION_FILES_DOWNLOAD_CHUNK: 'daemon.sessionFiles.download.chunk',
  DAEMON_SESSION_FILES_DOWNLOAD_FINALIZE: 'daemon.sessionFiles.download.finalize',
  DAEMON_SESSION_FILES_DOWNLOAD_ABORT: 'daemon.sessionFiles.download.abort',
  DAEMON_SESSION_ATTACHMENTS_UPLOAD_INIT: 'daemon.sessionAttachments.upload.init',
  DAEMON_SESSION_ATTACHMENTS_UPLOAD_CHUNK: 'daemon.sessionAttachments.upload.chunk',
  DAEMON_SESSION_ATTACHMENTS_UPLOAD_FINALIZE: 'daemon.sessionAttachments.upload.finalize',
  DAEMON_SESSION_ATTACHMENTS_UPLOAD_ABORT: 'daemon.sessionAttachments.upload.abort',
