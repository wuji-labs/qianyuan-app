export function showRelayHelp(): void {
  ...
  console.log('  --lan           Bind to your LAN IP (auto-detected; prompts if multiple interfaces found)');
  console.log('  --expose        Bind to all interfaces (0.0.0.0) — reachable from LAN and beyond');
