...
export const EDITABLE_THEME_COLOR_TOKEN_DEFINITIONS = [
    ...
    defineEditableThemeColorToken({ id: 'effect.surfaceHighlight', path: ['effect', 'surfaceHighlight'], group: 'effect', label: 'Surface highlight', description: 'Color-only edge highlight for Crisp card, popover, and composer surfaces.', valueKind: 'color' }),
