-- AlterTable
ALTER TABLE "Session" ADD COLUMN "meaningfulActivityAt" TIMESTAMP(3);
...
-- CreateIndex
CREATE INDEX "Session_accountId_meaningfulActivityAt_id_idx" ON "Session"("accountId", "meaningfulActivityAt" DESC, "id" DESC);
