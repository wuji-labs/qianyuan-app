...
- `[partial]` Remote SSH bootstrap desktop UX + CLI parity
  ...
  - CLI entry: `apps/cli/src/cli/commands/machine/*` (help shows `happier machine bootstrap --ssh ...`)
...
- CLI relay upsert-by-url: `.project/logs/bootstrap-qa/codex-bootstrap-webcli-24502/13-cli-relay-upsert-by-url.json`
...
- `HAPPIER_STACK_STACK=codex-bootstrap-webcli-24502 node ./apps/stack/bin/hstack.mjs happier relay upsert-by-url http://127.0.0.1:24502 --use --json`
