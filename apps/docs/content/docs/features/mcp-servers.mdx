...
Happier currently supports:

- **Native MCP delivery** on providers such as Claude, Codex, OpenCode, Kiro, and compatible custom ACP backends
- **Shell-bridge delivery** on providers such as Gemini, Auggie, Qwen, Kimi, Kilo, Pi, and Copilot
